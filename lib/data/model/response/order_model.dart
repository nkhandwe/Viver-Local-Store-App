...
class OrderModel {
  ...
  String cod_payment_method_name;
  ...
  OrderModel.fromJson(Map<String, dynamic> json) {
    ...
    cod_payment_method_name = json['cod_payment_method_name'];
    cod_payment_method_type_name = json['cod_payment_method_type_name'];
    cod_payment_method_image = json['cod_payment_method_image'];
  ...
  Map<String, dynamic> toJson() {
    ...
    data['cod_payment_method_name'] = this.cod_payment_method_name;
