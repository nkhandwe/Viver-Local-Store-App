...
import 'package:sixam_mart_store/view/screens/store/global_item_screen.dart';
...
class RouteHelper {
  ...
  static String globalItems = '/global-items';
  ...
  static String getGlobalItemsRoute() => '$globalItems';
  ...
  static List<GetPage> routes = [
    ...
    GetPage(name: globalItems, page: () => GlobalItemScreen()),
  ];
}
